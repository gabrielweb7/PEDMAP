    ...
    <section class="conteudo">
        ...
        <div class="container">
            ...
            <div class='table-responsive'>
                ...
                <input type="hidden" id="dataColumnDefs" value='[{ "width": "15%", "targets": 5 },{"className":"align-center", "targets": "align-center"},{ "orderable": false, "targets": "no-sort" }]' />

                <!-- table :: getDataAjax -->
                <table id="getDataAjax" class="table table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th class="no-sort"> <input type="checkbox" name="selectAllRegistro" /> </th>
                            <th>Titulo</th>
                            <th>Descricao</th>
                            <th>Conteudo</th>
                            <th>Imagem SRc</th>
                            <th class="align-center">Categoria JSON</th>
