    ...
    <section class="conteudo">
        ...
        <div class="container">
            ...
            <div class="tableActions">
                ...
                <!-- addRegistro -->
                <div class="addRegistro"> <a href="{{ route('modulo-'.$menuItem->modulo_nome.'-create') }}"> <button type="button" class="btn btn-primary">Novo Problema</button> </a> </div>
            ...
            <div class='table-responsive'>
                ...
                <input type="hidden" id="dataColumnDefs" value='[{ "width": "1%", "targets": 0 },{ "width": "10%", "targets": 2 },{ "width": "10%", "targets": 3 },{"className":"align-center", "targets": "align-center"},{ "orderable": false, "targets": "no-sort" }]' />
                ...
                <table id="getDataAjax" class="table table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>Problema</th>
                            <th class="align-center">Visibilidade</th>
