    ...
    <section class="conteudo">
        ...
        <div class="container">
            ...
            <div class="tableActions">
                ...
                <!-- addRegistro -->
                <div class="addRegistro"> <a href="{{ route('modulo-'.$menuItem->modulo_nome.'-create') }}"> <button type="button" class="btn btn-primary" style='    margin-bottom: 7px; margin-top: 2px;'>Novo Registro</button> </a> </div>
            ...
            <div class='table-responsive'>
                ...
                <input type="hidden" id="dataColumnDefs" value='[{ "width": "1%", "targets": 0 },{ "width": "10%", "targets": 3 },{"className":"align-center", "targets": "align-center"},{ "orderable": false, "targets": "no-sort" }]' />
