    ...
    <section class="conteudo">
        ...
        <div class="container">
            ...
            <div class='table-responsive'>
                ...
                <input type="hidden" id="dataColumnDefs" value='[{ "width": "1%", "targets": 0 },{ "width": "20%", "targets": 2 },{ "width": "10%", "targets": 3 },{ "width": "10%", "targets": 4 },{ "width": "10%", "targets": 5 },{"className":"align-center", "targets": "align-center"},{ "orderable": false, "targets": "no-sort" }]' />
                ...
                <table id="getDataAjax" class="table table-bordered" style="width:100%">
                    ...
                    <tr>
                        ...
                        <th>Retranca</th>
                        <th class="align-center">Local Referência</th>
                        <th class="align-center">Favorito</th>
                        <th class="align-center">Status</th>
                        <th class="align-center">Criado</th>
