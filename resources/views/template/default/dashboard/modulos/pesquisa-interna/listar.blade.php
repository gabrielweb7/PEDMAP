    ...
    <section class="conteudo">
        ...
        <div class="container">
            ...
            <div class="tableActions">
                ...
                <!-- addRegistro -->
                <!-- <div class="addRegistro"> <a href="{{ route('modulo-'.$menuItem->modulo_nome.'-create') }}"> <button type="button" class="btn btn-primary">Nova Pesquisa</button> </a> </div> -->
            ...
            <div class='table-responsive'>
                ...
                <input type="hidden" id="dataOrderDefault" value="6" />
                <input type="hidden" id="dataOrderDefaultSentido" value="desc" />
                <input type="hidden" id="dataColumnDefs" value='[{ "width": "1%", "targets": 0 },{ "width": "13%", "targets": 6 },{"className":"align-center", "targets": "align-center"},{ "orderable": false, "targets": "no-sort" }]' />
                ...
                <table id="getDataAjax" class="table table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>Estado Civil</th>
                            <th>Escolaridade</th>
                            <th class="align-center">Sexo</th>
                            <th class="align-center">Idade</th>
                            <th class="align-center">Data Hora</th>
