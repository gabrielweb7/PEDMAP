...
/* Request Validates */
use App\Http\Requests\modulo\noticiascat\CreateValidate;
use App\Http\Requests\modulo\noticiascat\UpdateValidate;
...
class NoticiasCatController extends Controller
{

    /* Configurações do Modulo */
    var $moduloNome = "noticiascat";
    var $moduloClass = \App\Noticiascat::class;
    var $moduloTableColunasSelect = array('id','categoria','visivel','datahora'); /* Colunas Select SQL */

    var $moduloTableColunasSearch = array('categoria','datahora'); /* Colunas Search Like SQL */

    var $moduloTableColunasOrdemFrontEnd = array('id','categoria','visivel'); /* Colunas na ordem visivel do FRONT-END */
