...
/* Request Validates */
use App\Http\Requests\modulo\anotacoes\CreateValidate;
use App\Http\Requests\modulo\anotacoes\UpdateValidate;
...
class AnotacoesController extends Controller
{
    ...
    var $moduloNome = "anotacoes";

    /* Tabela Admin */
    var $tableName = "modulo_anotacoes";

    /* Model*/
    var $moduloClass = \App\Anotacoes::class;
    ...
    /* Select > Select */
    var $moduloTableColunasSelect = array('id','bairro','bairro_id','anotacoes','datahora'); /* Colunas Select SQL */

    /* Select > Search */
    var $moduloTableColunasSearch = array('bairro','anotacoes'); /* Colunas Search Like SQL */

    /* Select > Front End */
    var $moduloTableColunasOrdemFrontEnd = array('id','anotacoes','bairro','datahora'); /* Colunas na ordem visivel do FRONT-END */
    ...
    public function listar(Request $request) {
         ...
         foreach($registros as $registro) {
            ...
            $loopData[] = (string)Helper::limitarTexto($registro->anotacoes, 100);

            $loopData[] = ($registro->bairro()->bairro);
    ...
    public function createPost(CreateValidate $request) {
        ...
        $registro->anotacoes = $request->anotacoes;
        ...
        return redirect()->route('modulo-'.$this->moduloNome.'-update',['id'=>$registro->id,'created'=>1]);
