...
/* Request Validates */
use App\Http\Requests\modulo\bairros\CreateValidate;
use App\Http\Requests\modulo\bairros\UpdateValidate;
...
class BairrosController extends Controller
{
    ...
    var $moduloNome = "bairros";

    /* Model*/
    var $moduloClass = \App\BairrosRegioes::class;
    ...
    public function listar(Request $request) {
         ...
         foreach($registros as $registro) {
             ...
             $loopData[] = (string)$registro->regiao;

             $loopData[] = (string)$registro->cidade->nome;
