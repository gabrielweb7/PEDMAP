...
/* Request Validates */
use App\Http\Requests\modulo\escolas\CreateValidate;
use App\Http\Requests\modulo\escolas\UpdateValidate;
...
class EscolasController extends Controller
{
    ...
    var $moduloNome = "escolas";

    var $moduloClass = \App\Escolas::class;
    var $moduloTableColunasSelect = array('id','nome','administracao','zona','cod','endereco','numero','bairro','complemento','cep','telefone','email','situacao','datahora'); /* Colunas Select SQL */
    var $moduloTableColunasSearch = array('nome','situacao','datahora'); /* Colunas Search Like SQL */

    var $moduloTableColunasOrdemFrontEnd = array('id','nome','situacao'); /* Colunas na ordem visivel do FRONT-END */
    ...
    public function listar(Request $request) {
        ...
        foreach($registros as $registro) {
            ...
            $loopData[] = (string)$registro->situacao;
    ...
    public function createPost(CreateValidate $request) {
        ...
        $registro->administracao = $request->administracao;
        $registro->zona = $request->zona;
        ...
        $registro->situacao = $request->situacao;
