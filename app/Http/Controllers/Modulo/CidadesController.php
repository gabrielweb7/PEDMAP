...
/* Request Validates */
use App\Http\Requests\modulo\cidades\CreateValidate;
use App\Http\Requests\modulo\cidades\UpdateValidate;
...
class CidadesController extends Controller
{
    ...
    var $moduloNome = "cidades";

    /* Model*/
    var $moduloClass = \App\Cidades::class;
    var $model = null; /* Model admin */
    var $clienteModel = null; /* Model Client */

    /* Select > Select */
    var $moduloTableColunasSelect = array('id','estado_id','nome','bandeira'); /* Colunas Select SQL */

    /* Select > Search */
    var $moduloTableColunasSearch = array('estado_id','nome'); /* Colunas Search Like SQL */

    /* Select > Front End */
    var $moduloTableColunasOrdemFrontEnd = array('id','nome','estado_id'); /* Colunas na ordem visivel do FRONT-END */
    ...
    public function listar(Request $request) {
         ...
         foreach($registros as $registro) {
             ...
             $loopData[] = (string)$registro->estado->nome;
