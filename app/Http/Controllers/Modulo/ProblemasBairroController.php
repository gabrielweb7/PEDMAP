...
/* Request Validates */
use App\Http\Requests\modulo\problemas_bairro\CreateValidate;
use App\Http\Requests\modulo\problemas_bairro\UpdateValidate;
...
class ProblemasBairroController extends Controller
{

    /* Configurações do Modulo */
    var $moduloNome = "problemas-bairro";
    var $moduloClass = \App\ProblemasBairro::class;
    var $moduloTableColunasSelect = array('id','problema','visivel','datahora'); /* Colunas Select SQL */
    var $moduloTableColunasSearch = array('problema','datahora'); /* Colunas Search Like SQL */

    var $moduloTableColunasOrdemFrontEnd = array('id','problema','visivel'); /* Colunas na ordem visivel do FRONT-END */
    ...
    public function listar(Request $request) {
        ...
        foreach($registros as $registro) {
            ...
            $loopData[] = (string)$registro->problema;

            $loopData[] = (string)$registro->visivel_string;
    ...
    public function createPost(CreateValidate $request) {
        ...
        $registro->problema = $request->problema;
        $registro->visivel = base64_decode($request->visivel);
