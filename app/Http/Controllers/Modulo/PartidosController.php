...
/* Request Validates */
use App\Http\Requests\modulo\partidos\CreateValidate;
use App\Http\Requests\modulo\partidos\UpdateValidate;
...
class PartidosController extends Controller
{
    ...
    var $moduloNome = "partidos";

    /* Tabela Admin */
    var $tableName = "modulo_partidos";

    /* Model*/
    var $moduloClass = \App\Partidos::class;
    ...
    /* Select > Select */
    var $moduloTableColunasSelect = array('id','nome','sigla','numero_eleitoral','presidente_atual','datahora'); /* Colunas Select SQL */

    /* Select > Search */
    var $moduloTableColunasSearch = array('nome','sigla','numero_eleitoral','presidente_atual'); /* Colunas Search Like SQL */

    /* Select > Front End */
    var $moduloTableColunasOrdemFrontEnd = array('id','nome','sigla','numero_eleitoral','presidente_atual','datahora'); /* Colunas na ordem visivel do FRONT-END */
    ...
    public function listar(Request $request) {
         ...
         foreach($registros as $registro) {
             ...
             $loopData[] = (string)$registro->numero_eleitoral;

             $loopData[] = (string)$registro->presidente_atual;
    ...
    public function createPost(CreateValidate $request) {
        ...
        $registro->numero_eleitoral = $request->numero_eleitoral;

        $registro->presidente_atual = $request->presidente_atual;
